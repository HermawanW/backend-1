<?php
    ...
    if ( isset($_POST["submit"]) ) {
        ...
        $merek = $_POST["merek"];
        $plat_mb = $_POST["plat_mb"];

        $tambahmb = "INSERT INTO mobil 
                    VALUES 
                    ('', '$mobil', '$nama_mb', '$merek', '$plat_mb')";
        mysqli_query($koneksi, $tambahmb);
                ...
                <table class="table table-dark" >
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td for="nama_mb">
                                <input type="text" name="nama_mb" id="nama_mb"> 
                            </td>
                            <td for="merek">
                                <input type="text" name="merek" id="merek"> 
                            </td>
                            <td for="plat_mb">
                                <input type="text" name="plat_mb" id="plat_mb"> 
                            </td>
                        </tr>
                    </tbody>
                </table>               
