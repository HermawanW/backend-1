<?php
    ...
    $result_mb = mysqli_query($koneksi, "SELECT * FROM mobil")
      ...
      <div class="row no-gutters mt-5">
        ...
        <div class="col-md-10 p-5">
            <table class="table table-dark">
                ...
                <tbody>
                    <?php $i=1; ?>
                    <?php while ( $row_mb = mysqli_fetch_assoc($result_mb) ) : ?>
                    <tr>
                        <th><?= $i ; ?></th>
                        <td><img src="img/<?php echo $row_mb['mobil']; ?>" width="300px" height="100px"></td>
                        <td><?= $row_mb["nama_mb"]; ?></td>
                        <td><?= $row_mb["merek"]; ?></td>
                        <td><?= $row_mb["plat_mb"]; ?></td>
                        <td>
                            <a href="hapusmobil.php?id_mobil=<?= $row_mb["id_mobil"]; ?>" class="btn-outline-light p-2 rounded" onclick=" return confirm('Apakah anda yakin ingin menghapus ?')">
            ...
            <a href="tambahmobil.php" class="btn btn-dark">Tambah Sopir <i class="fas fa-user-plus"></i></a>
        </div>
      </div>
